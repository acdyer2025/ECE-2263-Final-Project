...
void calibrate()
{
  ...
  thresholds[0] = values[0] - 3;
  thresholds[1] = values[1] - 3;
  thresholds[2] = values[2] - 2;
  thresholds[3] = values[3] - 1;
  thresholds[4] = values[4] - 1;
  thresholds[5] = values[5] - 2;
